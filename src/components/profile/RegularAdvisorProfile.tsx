...
import { Linkedin, Calendar, Pencil } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Progress } from "@/components/ui/progress";
import { useIsMobile } from '@/hooks/use-mobile';

interface RegularAdvisorProfileProps {
  advisor: AdvisorData;
}

const RegularAdvisorProfile: React.FC<RegularAdvisorProfileProps> = ({ advisor }) => {
  ...
  return (
    <div className="animate-scale-in space-y-3 md:space-y-4">
      ...
      <div className="space-y-3 md:space-y-4">
        ...
        {/* Boxed section for data completion */}
...
export default RegularAdvisorProfile;
